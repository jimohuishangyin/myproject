...
public class RsaHelper {
	 ...
	 * @return
	 */
	public static String encryptDataFromStr(String plainText, String pubKey) {
		...
		if (pubKey.equals("")) {
			...
			try {
				...
				byte[] encryptedDatByteArray = RsaHelper.encryptData(dataByteArray, decodePublicKeyFromXml(pubKey));
				return Base64Helper.encode(encryptedDatByteArray);
