...
public class VideoFragment extends Fragment implements ViewPager.OnPageChangeListener ,SwipeRefreshLayout.OnRefreshListener{

    private MainTabActivity mActivity;

    /*@ViewById(R.id.video_img_pager)
    AutoScrollViewPager mAutoScrollViewPager;
    @ViewById(R.id.video_img_text)
    TextView mTitleTextView;
    @ViewById(R.id.video_img_index)
    LinearLayout mIndexLinearLayout;*/
    @ViewById(R.id.video_list)
    LoadMoreView mListView;
    @ViewById(R.id.swipe_refresh)
    SwipeRefreshLayout mSwipeRefreshLayout;
    @ViewById(R.id.video_scrollview)
    ...
    private TuringAdapter mVideoAdapter;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mVideoAdapter = new TuringAdapter(mActivity, mArticleList,1);
    }
    ...
    void init() {
        ...
        mListView.setOnItemLoadClickListener(new LoadMoreView.OnItemLoadClickListener() {
            ...
            public void setOnItemLoadClick(int position, Object obj, View item) {
                Article a = mVideoAdapter.getItem(position);
   ...
   /* private void requestBannerList() {
        //请求幻灯片
        mActivity.requestBanner(4, new RequestListener() {
            @Override
