 ...
 */
public class VideoSearchFragment extends SearchBaseFragment {
    ...
    public void requestArticle() {
        ...
        mActivity.requestGet(Constants.SEARCH_CATALOGUE, params, ArticleList.class, new RequestListener() {
            ...
            public void onSuccess(Object result) {
                ...
                //设置viewpager宽度
                if ((mHeight -mTitleHeight-statusBarHeight ) > mListviewHeigeht) {
                    mActivity.setViewpageHeight((mHeight -mTitleHeight-statusBarHeight));
                } else {
                    mActivity.setViewpageHeight(mListviewHeigeht+mTitleHeight/2);
                }
            }
